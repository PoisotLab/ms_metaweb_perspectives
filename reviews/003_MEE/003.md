...
> discussion about "agreement" rather than "correctness". For this reason, we
> would like to have an editorial decision for this paper made without review.
> If this is not possible, we do not wish to move forward with *Methods Ecol
> Evol* as a venue for this article.
...
> We moved some of the information into a box (Box 2) and made a concrete list
> of three areas that should receive the most focus next. These are in the
...
> about ways to overcome issues that accumulated over centuries not on us. We
> have brought these issues to the attention of readers, and because the ways to
> handle them are very case-specific, we do not feel confident writing more
> about them.
...
> manuscript, and emphasized the main contribution in the first paragraph.
...
> embeddings are appropriate techniques for metaweb inference.
...
> relevant information. No changes made.
...
> performance in ecological network reconstructioh. The data in the Ghamesian et
...
> reviewers for making this comment, which strenghtens our message.
...
> references (cited in the manuscript) give a strong rationale for this.
...
> overlarge metaweb would affect bopth variance and bias of predictions.
...
> The s ection "Putting models in their context" is entirely dedicated to this
> point.
