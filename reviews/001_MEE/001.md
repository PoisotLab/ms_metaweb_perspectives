...
**TK** we can refer explicitly to l. 36 - 40 here as these outline the
objectives of the ms. Which obvi deviates from the og ms since that was a
specific 'sub-task' of embedding
...
> The second column of the table already specifies (explicitly) whether nodes
