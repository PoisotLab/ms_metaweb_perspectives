...
> description of what the *current submissions* includes would better be
> inferred from the abstract. Furthermore, we are unsure about what the intent
> of this comment is. As the reviewer has not formulated actionable critiques
> about the manuscript (such as, for example, the identification of areas where
> a better description of what the manuscript brings), no changes were made.
...
> alone is not a good predictor to the introduction.
