...
dimension, whilst maximally retaining key properties of the graph.
...
The popularity of graph embedding techniques in machine learning is
rather intuitive: while graphs are discrete objects, machine learning
techniques tend to handle continuous data better. Therefore, bringing a
discrete graph into a continuous vector space opens up a broader variety
of predictive algorithms.

\begin{longtable}[]{@{}lll@{}}
\toprule
Method & Embedded object & Reference\tabularnewline
\midrule
\endhead
DeepWalk & graph walk & Perozzi et al. (2014)\tabularnewline
node2vec & node embedding & Grover \& Leskovec (2016)\tabularnewline
graph2vec & sub-graph embedding & Narayanan et al. (2017)\tabularnewline
SDNE & nodes through auto-encoding & Wang et al. (2016)\tabularnewline
\bottomrule
\end{longtable}
