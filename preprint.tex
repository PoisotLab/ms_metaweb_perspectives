...
\toprule
Method & Embedding approach & Reference & Ecological
application\tabularnewline
\midrule
\endhead
RDPG & graphs through SVD & Young \& Scheinerman (2007) & Wardeh et al.
(2021)\tabularnewline
tSNE & nodes through statistical divergence & Hinton \& Roweis (2002)
&\tabularnewline
DeepWalk & graph walk & Perozzi et al. (2014) &\tabularnewline
FastEmbed & graph through PCA/SVD analogue & Ramasamy \& Madhow (2015)
&\tabularnewline
LINE & nodes through statistical divergence & Tang et al. (2015)
&\tabularnewline
SDNE & nodes through auto-encoding & D. Wang et al. (2016)
&\tabularnewline
node2vec & node embedding & Grover \& Leskovec (2016) &\tabularnewline
graph2vec & sub-graph embedding & Narayanan et al. (2017)
&\tabularnewline
HARP & nodes through a meta-strategy & Chen et al. (2017)
&\tabularnewline
