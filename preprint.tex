...
infer interactions to locations where inference is perhaps the least
required (and still leaves us unable to address regions without data);
second, accurate predictions often demand accurate predictors, and the
lack of methods that can leverage small amount of data is a serious
impediment to our global predictive ability. In most places, our most
reliable biodiversity knowledge is that of a species pool: through the
analysis of databases like GBIF or IUCN, it is possible to establish a
list of species in a region of interest; but establishing the
