...
cycle constitutes an instance of transfer learning, where the
transferred information is the representation of graph \textbf{A}
through its embedding.}\label{fig:embedding}
}
\end{figure}
