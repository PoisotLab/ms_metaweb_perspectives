...
\noindent {\LARGE \textbf{\textsf{Predicting metawebs: graph embeddings
can help alleviate spatial data deficiencies}}}
...
\centering
\includegraphics{figures/conceptual_predictions.jpg}
\caption{From a low-dimensional figure vector (see
